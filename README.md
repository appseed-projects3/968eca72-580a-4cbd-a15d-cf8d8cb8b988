...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-09 17:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/968eca72-580a-4cbd-a15d-cf8d8cb8b988.git
$ cd 968eca72-580a-4cbd-a15d-cf8d8cb8b988
```
